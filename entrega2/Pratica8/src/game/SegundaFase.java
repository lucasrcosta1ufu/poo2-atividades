 ...
 * @author Usuario
 */
public class SegundaFase extends JPanel implements Game
{
    ...
    private static SegundaFase instancia = null;
    
    public static SegundaFase getInstance(int gameType)
    {
        if (instancia == null) {
            instancia = new SegundaFase(gameType);
        }
        
        return instancia;
    }

    private SegundaFase(int gameType)
    {
        ...
        proximaFase = UltimaFase.getInstance(gameType);
        ...
        throws InterruptedException
    {
        ...
        SegundaFase game = (SegundaFase) g;
    ...
    public void setProximaFase()
    {
        ...
        proximaFase.setEnemys(getFactory(gameType).criarInimigosFortes(8));
