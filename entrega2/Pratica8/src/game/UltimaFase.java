 ...
 * @author Usuario
 */
public class UltimaFase extends JPanel implements Game
{
    ...
    public static UltimaFase getInstance(int gameType)
    {
        if (instancia == null) {
            instancia = new UltimaFase(gameType);
        }
        
        return instancia;
    }

    private UltimaFase(int gameType)
    {
