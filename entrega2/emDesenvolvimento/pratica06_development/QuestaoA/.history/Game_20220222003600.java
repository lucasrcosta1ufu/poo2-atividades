...
class Game extends JPanel {
    ...
    public Game() {
        personagens = new Personagem[numPersonagens];
    }
    ...
    public void autoGeneratePersonagens() {
        for (int i = 0; i < numPersonagens; i++) {
            personagens[i] = SimplePersonagemFactory.criaPersonagem();
        }
    }
    ...
    public void drawPersonagem(Personagem personagem, int posX, int posY) {
        g2d.drawImage(personagem.getCharacter(), posX, posY, Game.width, Game.height, null);
    }
